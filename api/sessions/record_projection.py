"""Compact sidebar projection for in-memory and metadata-only sessions."""

from __future__ import annotations

from api.usage import prompt_cache_hit_percent
from .record_recovery import _is_streaming_session, _last_message_timestamp
    ...
    def compact(self, include_runtime=False, active_stream_ids=None) -> dict:
        ...
        return {
            ...
            **({
            ...
            'user_message_count': self._compute_user_message_count(self.messages),
