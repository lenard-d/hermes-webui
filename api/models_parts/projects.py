"""Project persistence and CLI-session import.
        ...
        with _PROJECTS_MIGRATION_LOCK:
            ...
            if _backfill_project_profiles_if_needed(projects):
                try:
                    ...
                    _publish_models_global(globals(), "_projects_migrated", True)
                except Exception:
...
__all__ = ['_projects_migrated', '_backfill_project_profiles_if_needed', 'load_projects', 'save_projects', 'CRON_PROJECT_NAME', '_CRON_PROJECT_LOCK', 'ensure_cron_project', 'WEBHOOK_PROJECT_NAME', '_WEBHOOK_PROJECT_LOCK', 'ensure_webhook_project', '_profile_has_user_projects', 'is_cron_session', 'is_webhook_session', 'import_cli_session']
