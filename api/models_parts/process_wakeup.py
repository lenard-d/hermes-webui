"""Provider pause and credential-state handling.
...
__all__ = ['PROCESS_WAKEUP_PROVIDER_UNAVAILABLE_TYPES', 'PROCESS_WAKEUP_PAUSE_ERROR', '_PROCESS_WAKEUP_PAUSE_VERSION', '_process_wakeup_pause_part', '_process_wakeup_pause_provider_part', '_process_wakeup_pause_lane', '_process_wakeup_pause_int', '_process_wakeup_pause_float', '_process_wakeup_pause_key', 'process_wakeup_pause_matches', 'clear_process_wakeup_pause', 'clear_process_wakeup_pause_if_model_changed', 'record_process_wakeup_provider_unavailable_pause', 'suppress_process_wakeup_for_provider_pause', '_PROCESS_WAKEUP_AUTH_ROTATION_KEYS', '_PROCESS_WAKEUP_AUTH_SECRET_PRESENCE_KEYS', '_process_wakeup_secret_presence', '_process_wakeup_auth_fingerprint_payload', '_process_wakeup_auth_store_fingerprint', 'process_wakeup_credential_state_fingerprint', 'process_wakeup_pause_credential_state_changed', '_get_profile_home']
