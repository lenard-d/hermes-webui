// Panels domain: kanban events and task editing
...
window.HermesPanels.kanbanTask = {
  _scheduleKanbanRefresh,
  _kanbanBoardQuery,
  nudgeKanbanDispatcher,
  runKanbanDispatcher,
  _setKanbanDispatcherButtonsDisabled,
  _kanbanFormatDispatchResult,
  _kanbanSelectedTaskIds,
  bulkUpdateKanban,
  blockKanbanTask,
  unblockKanbanTask,
  closeKanbanTaskDetail,
  _kanbanFormatTimestamp,
  _kanbanEventSummary,
  _kanbanFormatDetailValue,
  _kanbanDetailSection,
  _kanbanCommentHtml,
  _kanbanEventHtml,
  _kanbanRunHtml,
  _kanbanJsArg,
  _kanbanLinkableTaskOptions,
  _kanbanLinksHtml,
  createKanbanTask,
  _invalidateKanbanProfileCache,
  _kanbanLoadProfileNames,
  _kanbanPopulateAssigneeSelect,
  openKanbanCreate,
  openKanbanEdit,
  _kanbanEditableStatusFor,
  _kanbanResetTaskModalFields,
  _kanbanSetTaskModalLabels,
  _kanbanSetTaskModalStatusHint,
  _kanbanPopulateTenantDatalist,
  _kanbanPopulateWorkspacePathDatalist,
  _kanbanPopulateParentsDatalist,
  _trapModalFocus,
