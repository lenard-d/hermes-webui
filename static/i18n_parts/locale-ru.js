// Complete ru translation bundle.
(function registerLocale(global) {
  'use strict';
  const api = global.HermesI18n;
  if (!api || typeof api.registerLocale !== 'function' || !api.helpersReady) {
    throw new Error('Hermes i18n bootstrap and helpers must load before locale scripts');
  }
  const helpers = api.helpers;
  api.registerLocale('ru', {
    // Core, commands, workspace, and settings.
    ...
    session_worktree_remove_untracked_warning: (count) => `${count} ${helpers._i18nRuPlural(count, 'неотслеживаемый файл будет удалён безвозвратно', 'неотслеживаемых файла будут удалены безвозвратно', 'неотслеживаемых файлов будет удалено безвозвратно')}.`,
    session_worktree_remove_ahead_warning: (ahead) => `${ahead} ${helpers._i18nRuPlural(ahead, 'незапушенный коммит будет потерян', 'незапушенных коммита будут потеряны', 'незапушенных коммитов будет потеряно')}.`,
    ...
    processed_elapsed: helpers._i18nProcessedElapsedRu,
    worklog_thinking: 'Размышление',
    tool_target_skill_suffix: 'навык',
    tool_action_label: helpers._i18nToolActionLabelRu,
    tool_worklog_summary: helpers._i18nToolWorklogSummaryRu,
    tool_summary_join: helpers._i18nToolSummaryJoinRu,
    done: 'Готово',
    ...
    gateway_session_count: (n) => `${n} ${helpers._i18nRuPlural(n, 'сеанс', 'сеанса', 'сеансов')}`,
    ...
    // Navigation, accessibility, providers, onboarding, and panels.
    login_title: 'Вход',
    ...
    session_meta_messages: (n) => `${n} ${helpers._i18nRuPlural(n, 'сообщение', 'сообщения', 'сообщений')}`,
    session_meta_children: (n) => `${n} ${helpers._i18nRuPlural(n, 'дочерний сеанс', 'дочерних сеанса', 'дочерних сеансов')}`,
    session_meta_segments: (n) => `${n} ${helpers._i18nRuPlural(n, 'предыдущий ход', 'предыдущих хода', 'предыдущих ходов')}`,
    ...
    external_notes_tool_count: (count) => `Доступно: ${count} ${helpers._i18nRuPlural(count, 'инструмент заметок', 'инструмента заметок', 'инструментов заметок')}`,
    ...
    profile_skill_count: (count) => `${count} ${helpers._i18nRuPlural(count, 'навык', 'навыка', 'навыков')}`,
    ...
    active_conversation_meta: (title, count) => `${title} · ${count} ${helpers._i18nRuPlural(count, 'сообщение', 'сообщения', 'сообщений')}`,
    ...
    checkpoint_diff_files_changed: (n) => `${n} ${helpers._i18nRuPlural(n, 'файл изменён', 'файла изменено', 'файлов изменено')}`,
