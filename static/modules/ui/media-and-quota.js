...
Object.defineProperties(compatibilityBindings, {
  _openImgLightbox: { enumerable: true, get: () => _openImgLightbox, set: (value) => { _openImgLightbox = value; } },
  _mermaidViewerIcon: { enumerable: true, get: () => _mermaidViewerIcon, set: (value) => { _mermaidViewerIcon = value; } },
  _createMermaidViewerButton: { enumerable: true, get: () => _createMermaidViewerButton, set: (value) => { _createMermaidViewerButton = value; } },
  _mermaidSvgBox: { enumerable: true, get: () => _mermaidSvgBox, set: (value) => { _mermaidSvgBox = value; } },
  _mountMermaidViewer: { enumerable: true, get: () => _mountMermaidViewer, set: (value) => { _mountMermaidViewer = value; } },
  _openMermaidLightbox: { enumerable: true, get: () => _openMermaidLightbox, set: (value) => { _openMermaidLightbox = value; } },
  _openImgLightboxWithNav: { enumerable: true, get: () => _openImgLightboxWithNav, set: (value) => { _openImgLightboxWithNav = value; } },
  _navigateLightbox: { enumerable: true, get: () => _navigateLightbox, set: (value) => { _navigateLightbox = value; } },
  _closeImgLightbox: { enumerable: true, get: () => _closeImgLightbox, set: (value) => { _closeImgLightbox = value; } },
  _getStoredMediaPlaybackRate: { enumerable: true, get: () => _getStoredMediaPlaybackRate, set: (value) => { _getStoredMediaPlaybackRate = value; } },
  _setStoredMediaPlaybackRate: { enumerable: true, get: () => _setStoredMediaPlaybackRate, set: (value) => { _setStoredMediaPlaybackRate = value; } },
  _syncMediaSpeedButtons: { enumerable: true, get: () => _syncMediaSpeedButtons, set: (value) => { _syncMediaSpeedButtons = value; } },
  _applyMediaPlaybackRate: { enumerable: true, get: () => _applyMediaPlaybackRate, set: (value) => { _applyMediaPlaybackRate = value; } },
  _mediaKindForName: { enumerable: true, get: () => _mediaKindForName, set: (value) => { _mediaKindForName = value; } },
  _mediaSpeedControlsHtml: { enumerable: true, get: () => _mediaSpeedControlsHtml, set: (value) => { _mediaSpeedControlsHtml = value; } },
  _mediaPlayerHtml: { enumerable: true, get: () => _mediaPlayerHtml, set: (value) => { _mediaPlayerHtml = value; } },
  _isSafeDataImageUri: { enumerable: true, get: () => _isSafeDataImageUri, set: (value) => { _isSafeDataImageUri = value; } },
  _dataImageHtml: { enumerable: true, get: () => _dataImageHtml, set: (value) => { _dataImageHtml = value; } },
  _mdImageHtml: { enumerable: true, get: () => _mdImageHtml, set: (value) => { _mdImageHtml = value; } },
  _inlineMediaHtmlForRef: { enumerable: true, get: () => _inlineMediaHtmlForRef, set: (value) => { _inlineMediaHtmlForRef = value; } },
  _renderAttachmentHtml: { enumerable: true, get: () => _renderAttachmentHtml, set: (value) => { _renderAttachmentHtml = value; } },
  _initMediaPlaybackObserver: { enumerable: true, get: () => _initMediaPlaybackObserver, set: (value) => { _initMediaPlaybackObserver = value; } },
  _formatQuotaMoneyShort: { enumerable: true, get: () => _formatQuotaMoneyShort, set: (value) => { _formatQuotaMoneyShort = value; } },
  _formatQuotaPercentShort: { enumerable: true, get: () => _formatQuotaPercentShort, set: (value) => { _formatQuotaPercentShort = value; } },
  _providerQuotaIndicatorText: { enumerable: true, get: () => _providerQuotaIndicatorText, set: (value) => { _providerQuotaIndicatorText = value; } },
  renderProviderQuotaIndicator: { enumerable: true, get: () => renderProviderQuotaIndicator, set: (value) => { renderProviderQuotaIndicator = value; } },
  refreshProviderQuotaIndicator: { enumerable: true, get: () => refreshProviderQuotaIndicator, set: (value) => { refreshProviderQuotaIndicator = value; } },
  _MERMAID_VIEWER_MIN_SCALE: { enumerable: true, get: () => _MERMAID_VIEWER_MIN_SCALE },
  _MERMAID_VIEWER_MAX_SCALE: { enumerable: true, get: () => _MERMAID_VIEWER_MAX_SCALE },
  _MERMAID_VIEWER_ZOOM_STEP: { enumerable: true, get: () => _MERMAID_VIEWER_ZOOM_STEP },
  _MERMAID_VIEWER_INLINE_MIN_HEIGHT: { enumerable: true, get: () => _MERMAID_VIEWER_INLINE_MIN_HEIGHT },
  _IMAGE_EXTS: { enumerable: true, get: () => _IMAGE_EXTS },
  _PDF_EXTS: { enumerable: true, get: () => _PDF_EXTS },
  _HTML_EXTS: { enumerable: true, get: () => _HTML_EXTS },
  _ARCHIVE_EXTS: { enumerable: true, get: () => _ARCHIVE_EXTS },
  _SVG_EXTS: { enumerable: true, get: () => _SVG_EXTS },
  _AUDIO_EXTS: { enumerable: true, get: () => _AUDIO_EXTS },
  _VIDEO_EXTS: { enumerable: true, get: () => _VIDEO_EXTS },
  _CSV_EXTS: { enumerable: true, get: () => _CSV_EXTS },
  _EXCALIDRAW_EXTS: { enumerable: true, get: () => _EXCALIDRAW_EXTS },
  MEDIA_PLAYBACK_RATES: { enumerable: true, get: () => MEDIA_PLAYBACK_RATES },
  MEDIA_PLAYBACK_STORAGE_KEY: { enumerable: true, get: () => MEDIA_PLAYBACK_STORAGE_KEY },
  _DATA_IMAGE_RE: { enumerable: true, get: () => _DATA_IMAGE_RE },
  _DATA_IMAGE_SVG_RE: { enumerable: true, get: () => _DATA_IMAGE_SVG_RE },
  _DATA_IMAGE_MAX_LEN: { enumerable: true, get: () => _DATA_IMAGE_MAX_LEN },
  MODEL_STATE_KEY: { enumerable: true, get: () => MODEL_STATE_KEY },
  PENDING_SESSION_MODEL_PREFIX: { enumerable: true, get: () => PENDING_SESSION_MODEL_PREFIX },
  PENDING_SESSION_MODEL_MAX_AGE_MS: { enumerable: true, get: () => PENDING_SESSION_MODEL_MAX_AGE_MS },
  _providerQuotaRefreshInFlight: { enumerable: true, get: () => _providerQuotaRefreshInFlight, set: (value) => { _providerQuotaRefreshInFlight = value; } },
  _dynamicModelLabels: { enumerable: true, get: () => _dynamicModelLabels, set: (value) => { _dynamicModelLabels = value; } },
});
