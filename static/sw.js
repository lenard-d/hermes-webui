...
const SHELL_ASSETS = [
  ...
  './static/modules/commands/forced-skill-directive.js',
  './static/modules/commands/capability-commands.js',
  './static/modules/commands/desktop-companion.js',
  './static/modules/commands/manual-compression.js',
  './static/modules/commands/model-command.js',
  './static/modules/commands/preference-commands.js',
  './static/modules/commands/run-controls.js',
  './static/modules/commands/session-history.js',
  './static/modules/commands/workspace-commands.js',
  './static/modules/commands/command-catalog.js',
  './static/modules/commands/remote-command-catalog.js',
  './static/modules/commands/slash-autocomplete.js',
  './static/modules/commands/command-dropdown.js',
  ...
  './static/modules/ui/composer-primary-control.js',
  './static/modules/ui/composer-queue.js',
  './static/modules/ui/composer-state.js',
  ...
  './static/modules/ui/markdown-renderer.js',
  ...
  './static/modules/ui/compression-recovery.js',
  './static/modules/ui/dashboard-navigation.js',
  './static/modules/ui/message-navigation.js',
  './static/modules/ui/message-viewport-anchor.js',
  './static/modules/ui/message-virtualization.js',
  './static/modules/ui/message-virtualization-state.js',
  './static/modules/ui/offline-recovery.js',
  './static/modules/ui/session-queue-state.js',
  './static/modules/ui/user-message-presentation.js',
  './static/modules/ui/transcript-render-dispatch.js',
  ...
  './static/modules/ui/tool-identity.js',
  './static/modules/ui/tool-call-presentation.js',
  './static/modules/ui/tool-card-presentation.js',
  './static/modules/ui/worklog-disclosure-identity.js',
  './static/modules/ui/worklog-tool-groups.js',
  './static/modules/ui/live-tool-worklog.js',
  './static/modules/ui/state.js',
  './static/modules/ui/tool-worklog.js',
  './static/modules/ui/thinking-lifecycle.js',
  './static/modules/ui/transparent-turn-presentation.js',
  './static/modules/ui/worklog-disclosure.js',
  './static/modules/ui/worklog-reasoning.js',
  './static/modules/ui/worklog-step-presentation.js',
  './static/modules/ui/anchor-scene-presentation.js',
  './static/modules/ui/live-anchor-reconciliation.js',
  './static/modules/ui/toolsets-controls.js',
  './static/modules/ui/topbar-presentation.js',
  './static/modules/ui/toast-notifications.js',
  ...
  './static/modules/sessions/session-load-state.js',
  './static/modules/sessions/session-list-coordination.js',
  './static/modules/sessions/session-profile-scope.js',
  './static/modules/sessions/session-run-registry.js',
  './static/modules/sessions/session-display.js',
  './static/modules/sessions/session-source.js',
  './static/modules/sessions/composer-drafts.js',
  './static/modules/sessions/session-unread.js',
  './static/modules/sessions/session-run-state.js',
  './static/modules/sessions/session-live-recovery.js',
  './static/modules/sessions/session-visit.js',
  './static/modules/sessions/session-lifecycle-port.js',
  './static/modules/sessions/session-post-load.js',
  './static/modules/sessions/handoff-lifecycle.js',
  './static/modules/sessions/current-turn-transcript.js',
  './static/modules/sessions/older-message-pagination.js',
  './static/modules/sessions/transcript-window-state.js',
  './static/modules/sessions/new-session.js',
  './static/modules/sessions/session-profile-load.js',
  './static/modules/sessions/session-load-recovery.js',
  './static/modules/sessions/existing-session-load.js',
  './static/modules/sessions/lifecycle.js',
  './static/modules/sessions/transcript-loading.js',
  './static/modules/sessions/message-loading.js',
  './static/modules/sessions/message-timeline.js',
  './static/modules/sessions/sidebar-render-port.js',
  './static/modules/sessions/sidebar-store.js',
  './static/modules/sessions/sidebar-motion.js',
  './static/modules/sessions/session-navigation.js',
  './static/modules/sessions/sidebar-cache.js',
  './static/modules/sessions/sidebar-selection.js',
  './static/modules/sessions/session-action-menu.js',
  './static/modules/sessions/session-rename.js',
  './static/modules/sessions/session-portability-actions.js',
  './static/modules/sessions/session-archive-actions.js',
  './static/modules/sessions/session-projects.js',
  './static/modules/sessions/sidebar-actions.js',
  './static/modules/sessions/sidebar-render-state.js',
  './static/modules/sessions/sidebar-state.js',
  './static/modules/sessions/session-list-render-port.js',
  './static/modules/sessions/session-list-skeleton.js',
  './static/modules/sessions/session-list-reconciliation.js',
  './static/modules/sessions/session-list-loader.js',
  './static/modules/sessions/session-list-refresh.js',
  './static/modules/sessions/sidebar-session-events.js',
  './static/modules/sessions/session-list.js',
  './static/modules/sessions/session-search.js',
  './static/modules/sessions/session-time.js',
  './static/modules/sessions/session-lineage.js',
  './static/modules/sessions/session-lineage-report.js',
  './static/modules/sessions/session-child-attachment.js',
  './static/modules/sessions/session-row-labels.js',
  './static/modules/sessions/session-discovery.js',
  './static/modules/sessions/sidebar-session-opening.js',
  './static/modules/sessions/sidebar-row-state.js',
  './static/modules/sessions/sidebar-virtualization.js',
  './static/modules/sessions/sidebar-project-controls.js',
  './static/modules/sessions/sidebar-row-gestures.js',
  './static/modules/sessions/sidebar-interactions.js',
  './static/modules/sessions/sidebar-row-presentation.js',
  './static/modules/sessions/sidebar-list-orchestrator.js',
  './static/modules/sessions/sidebar-renderer.js',
  './static/modules/sessions/session-removal.js',
  './static/modules/sessions/session-navigation-events.js',
  ...
  './static/modules/messages/anchor-live.js',
  ...
  './static/modules/messages/content-events.js',
  ...
  './static/modules/messages/stream-content.js',
  './static/modules/messages/stream-link-policy.js',
  './static/modules/messages/stream-media.js',
  './static/modules/messages/stream-fade.js',
  './static/modules/messages/stream-markdown.js',
  './static/modules/messages/anchor-prose-rendering.js',
  ...
  './static/modules/messages/session-recovery.js',
  './static/modules/messages/stream-lifecycle.js',
  './static/modules/messages/stream-progress.js',
  './static/modules/messages/stream-transcript.js',
  './static/modules/messages/stream-transport.js',
  ...
  './static/modules/panels/extensions/catalog.js',
  './static/modules/panels/extensions/configuration.js',
  './static/modules/panels/extensions/diagnostics.js',
  './static/modules/panels/extensions/installations.js',
  './static/modules/panels/extensions/installed.js',
  './static/modules/panels/extensions/sidecars.js',
  './static/modules/panels/settings-models-auth.js',
  './static/modules/panels/settings-navigation.js',
  './static/modules/panels/settings-plugins.js',
