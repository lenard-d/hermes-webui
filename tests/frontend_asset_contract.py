...
_SESSION_MODULE_NAMES = (
    ...
    "session-visit.js",
    "session-lifecycle-port.js",
    "session-post-load.js",
    "handoff-lifecycle.js",
    "current-turn-transcript.js",
    "older-message-pagination.js",
    "transcript-window-state.js",
    "new-session.js",
    "session-profile-load.js",
    "session-load-recovery.js",
    "existing-session-load.js",
    "lifecycle.js",
    "transcript-loading.js",
    "message-loading.js",
    "message-timeline.js",
    ...
    "session-action-menu.js",
    "session-rename.js",
    "session-portability-actions.js",
    "session-archive-actions.js",
    "session-projects.js",
    "sidebar-actions.js",
    ...
    "session-time.js",
    "session-lineage.js",
    "session-lineage-report.js",
    "session-child-attachment.js",
    "session-row-labels.js",
    "session-discovery.js",
    "sidebar-session-opening.js",
    "sidebar-row-state.js",
    "sidebar-virtualization.js",
    "sidebar-project-controls.js",
    "sidebar-row-gestures.js",
    "sidebar-interactions.js",
    "sidebar-row-presentation.js",
    "sidebar-list-orchestrator.js",
    "sidebar-renderer.js",
    "session-removal.js",
    "session-navigation-events.js",
    "management.js",
    "index.js",
)
