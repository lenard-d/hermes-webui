...
_SIDEBAR_LIST_LOADER = (
    _ROOT / "static" / "modules" / "sessions" / "session-list-loader.js"
).read_text(encoding="utf-8")


def test_sidebar_allowlist_preserves_read_only_and_gateway_routing():
    allow = sidebar_projection._SIDEBAR_SESSION_RESPONSE_FIELDS
...
def test_sidebar_response_item_preserves_read_only_flag():
    """The sidebar projection preserves rendering metadata and rejects detail fields."""
